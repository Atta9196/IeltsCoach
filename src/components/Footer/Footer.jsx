      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">IELTS Coach</h3>
            <p className="text-gray-300 mb-4">
              Your comprehensive IELTS preparation platform. Master all four skills with expert guidance and practice tests.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/practice" className="text-gray-300 hover:text-white transition">Practice</Link></li>
              <li><Link to="/tests" className="text-gray-300 hover:text-white transition">Mock Tests</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} IELTS Coach. All rights reserved.
            </p>
            <p className="text-gray-400 text-sm mt-2 md:mt-0">
              Made with ❤️ for IELTS aspirants worldwide
            </p>
          </div>
        </div>
      </div>
